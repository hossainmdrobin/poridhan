...
import { productVectorSearch } from './productLoots';

const checkpointer = new MemorySaver()

const tools = [searchInfo, productVectorSearch]
...
async function callModel(state) {
    ...
    const systemMessage = new SystemMessage(`You are a customer support chatbot for our store.
        STRICT RULES:
