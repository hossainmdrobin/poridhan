...
export async function seedInfo(force = false) {
  ...
  const info = [
    ...
    { text: 'Services: We offer fast delivery of clothes within 2 hours in our local area- Gorai(union), Mirjapur,tangail and nearby areas. Our dedicated team ensures you receive your orders promptly and in perfect condition.' },
  ...
  const created = await Info.insertMany(info);
